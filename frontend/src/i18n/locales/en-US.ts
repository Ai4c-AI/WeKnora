...
\
  ...
  ontologyReview: {
    ...
    queueTitle: 'Ontology Review Queue',
    review: 'Review',
    ...
    statusNoReview: 'No Review',
    emptyQueueTitle: 'No Items Pending',
    emptyQueueDesc: 'All ontology slices in this KB have been reviewed or not yet generated. Upload new documents with ontology extraction enabled to populate this queue.',
    sourceText: 'Source Text (Evidence Highlighted)',
    classes: 'Classes',
    ...
    approveAllConfirm: 'Mark all raw ontology items in this chunk as reviewed? This will write an audit log entry.',
    approveAllSuccess: 'All items approved',
    actionApplied: 'Review action applied',
    editItem: 'Edit {id}',
    editHint: 'Edit the JSON below directly (keep schema consistent), then confirm.',
    emptyOntology: 'No ontology content extracted for this chunk.',
  },
}
