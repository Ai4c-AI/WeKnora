export default {
  ...
  ontologyReview: {
    ...
    statusRejected: "已拒绝",
    statusNoReview: "无需审核",
    emptyQueueTitle: "暂无待审核项",
    emptyQueueDesc: "当前知识库中所有 ontology 切片均已审核或尚未生成。上传新文档并开启 ontology 抽取后，条目将出现在此队列中。",
    sourceText: "原文 (Evidence 高亮)",
    classes: "Classes",
    ...
    edit: "编辑",
    approveAll: "全部通过",
    approveAllConfirm: "确认将此 Chunk 的所有 raw ontology 标记为已审核？此操作将写入审计日志。",
    approveAllSuccess: "已全部通过审核",
    actionApplied: "审核动作已提交",
    editItem: "编辑 {id}",
    editHint: "直接修改下方 JSON（请保持 schema 一致性），确认后提交。",
    emptyOntology: "此 Chunk 暂无提取出的 ontology 内容。",
  },
};
